...
import CountyScreen from './pages/CountyScreen';
        ...
        <IonReactRouter>
          <IonTabs>
            <IonRouterOutlet animated={false}>
              ...
              <Route path={`${Globals.pwaUrl}/:tab(county)`} render={(props: any) => <CountyScreen {...props} />} exact={true} />
              <Route path={`${Globals.pwaUrl}/:tab(county)/:countyName/:hospitalName`} render={(props: any) => <ListScreen {...props} />} exact={true} />
              <Route path={`${Globals.pwaUrl}/:tab(county)/:countyName/:hospitalName/:clinicNo`} render={(props: any) => <DetailScreen {...props} />} exact={true} />
            ...
            <IonTabBar slot="bottom">
              ...
              <IonTabButton tab="county" href={`${Globals.pwaUrl}/county`}>
                <IonIcon icon={list} />
              </IonTabButton>
        ...
        <IonAlert
          ...
          buttons={[
            ...
            },
            {
              ...
              handler: (value) => {
                window.open('https://github.com/MrMYHuang/thcs#history');
              },
            }
          ]}
        />
